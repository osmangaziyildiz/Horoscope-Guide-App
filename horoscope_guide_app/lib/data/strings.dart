...
class Strings {
  ...
  static const String horoscopeGuide = "Horoscope Guide";

  static const List<String> horoscopeNames = [
    "Koc",
    "Boga",
    "Ikizler",
    "Yengec",
  ...
  static const List<String> horoscopeDates = [
    "21 Mart - 20 Nisan",
    "21 Nisan - 21 Mayıs",
    "22 Mayıs - 22 Haziran",
  ...
  static const List<String> horoscopeGeneralDetail = [
    "\tGenel Özellikler\n\n"
